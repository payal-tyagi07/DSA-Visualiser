...
const SearchRotated = () => {
  const pseudocodeLines = [
    "procedure searchRotated(arr, target):",
  ...
  const generateSteps = (arr, t) => {
    ...
    steps.push({
      ...
      mid: null,
      found: null,
      description: `Search for ${t} in rotated array [${arr.join(', ')}]`,
      pseudocodeLine: 1
    });
    ...
    while (low <= high) {
      ...
      if (arr[mid] === t) {
        ...
        steps.push({
          ...
          mid,
          found,
          description: `Found ${t} at index ${mid}! 🎉`,
          pseudocodeLine: 3
        });
        break;
      }
      ...
      if (arr[low] <= arr[mid]) {
        if (arr[low] <= t && t < arr[mid]) {
          ...
          steps.push({
            ...
            mid,
            found: null,
            description: `Left half sorted, ${t} in [${arr[low]}, ${arr[mid-1]}] → high = ${high}`,
            pseudocodeLine: 6
          });
        } else {
          low = mid + 1;
          steps.push({
            ...
            mid,
            found: null,
            description: `Left half sorted, ${t} not in left → low = ${low}`,
            pseudocodeLine: 7
          });
        }
        ...
        if (arr[mid] < t && t <= arr[high]) {
          ...
          steps.push({
            ...
            mid,
            found: null,
            description: `Right half sorted, ${t} in [${arr[mid+1]}, ${arr[high]}] → low = ${low}`,
            pseudocodeLine: 10
          });
        } else {
          high = mid - 1;
          steps.push({
            ...
            mid,
            found: null,
            description: `Right half sorted, ${t} not in right → high = ${high}`,
            pseudocodeLine: 11
          });
        }
      }
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-[#0a0a0a] text-gray-200 rounded-2xl shadow-2xl transition-all duration-300 font-mono border border-[#222222]">
      <div className="text-center mb-6">
        <h2 className="text-3xl font-bold text-[#569cd6] mb-2">Search in Rotated Sorted Array</h2>
