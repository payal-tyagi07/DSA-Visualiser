...
const FindMinRotated = () => {
  const pseudocodeLines = [
    "procedure findMinRotated(arr):",
  ...
  const [array, setArray] = useState([4,5,6,7,0,1,2]);
  ...
  const generateSteps = (arr) => {
    ...
    steps.push({
      ...
      mid: null,
      result: null,
      description: `Find minimum in rotated array [${arr.join(', ')}]`,
      pseudocodeLine: 1
    });
    ...
    while (low < high) {
      ...
      if (arr[mid] > arr[high]) {
        ...
        steps.push({
          ...
          mid,
          result: null,
          description: `arr[${mid}] > arr[${high}] → min in right half, low = ${low}`,
          pseudocodeLine: 4
        });
      } else {
        high = mid;
        steps.push({
          ...
          mid,
          result: null,
          description: `arr[${mid}] <= arr[${high}] → min in left half, high = ${high}`,
          pseudocodeLine: 6
        });
      }
    ...
    steps.push({
      ...
      mid: null,
      result,
      description: `Minimum found at index ${result} (value = ${arr[result]}) 🎉`,
      pseudocodeLine: 7
    });
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-[#0a0a0a] text-gray-200 rounded-2xl shadow-2xl transition-all duration-300 font-mono border border-[#222222]">
      <div className="text-center mb-6">
        <h2 className="text-3xl font-bold text-[#569cd6] mb-2">Find Minimum in Rotated Sorted Array</h2>
      ...
      <form onSubmit={(e) => { e.preventDefault(); updateInputs(); }} className="flex flex-wrap justify-center gap-4 mb-6">
        <div className="flex items-center gap-2">
          <label className="text-[#9cdcfe]">Array (rotated):</label>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="lg:w-2/3 space-y-6">
            ...
            <div className="flex justify-center gap-6 flex-wrap text-sm">
              ...
              <div className="flex items-center gap-2"><span className="w-4 h-4 bg-green-600 rounded-full"></span>Minimum</div>
